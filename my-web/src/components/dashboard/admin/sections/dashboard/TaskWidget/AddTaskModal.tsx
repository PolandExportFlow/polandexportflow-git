...
import { NewTask, TaskType } from './tasksTypes'
...
export default function AddTaskModal({ isOpen, onClose, defaultType = 'paczki', onSubmit }: Props) {
  ...
  useEffect(() => {
    if (isOpen) {
      setForm({ task_name: '', task_description: '', task_type: defaultType, related_order_id: null })
    }
  }, [isOpen, defaultType])
    ...
    <Modal isOpen={isOpen} onClose={onClose} {...modalNarrow}>
      ...
      >
        ...
        <UniversalInput
          ...
          placeholder="Np. PEF-12345 albo UUID / dowolny identyfikator"
          type="text"
