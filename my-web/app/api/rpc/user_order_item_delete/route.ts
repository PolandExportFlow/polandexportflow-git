...
// Walidacja jest konieczna, aby nie wysypać bazy danych błędnym formatem stringa
...
export async function POST(req: Request) {
  try {
    ...
    // Jeśli frontend wyśle tymczasowe ID (np. "CREATING-xyz"), odrzucamy to tutaj,
    // zamiast crashować zapytanie SQL.
    if (!isUUID(item_id)) {
